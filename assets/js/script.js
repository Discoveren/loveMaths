...
function checkAnswer() {
  let userAnswer = parseInt(document.getElementById("answer-message").value);
...
function incrementScore() {
  //  retrieve the score from the DOM then increment it
  let oldScore = document.getElementById("score").innerText;
  document.getElementById("score").innerText = ++oldScore;
}
/**
 * Gets the current score from the DOM and increment the wrong answer score by 1
 */
